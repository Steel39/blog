                ...
                <div class="col-12">
                    <form action="{{ route('admin.user.store') }}"  method="POST" class="w-25">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Введите нового пользователя...">
                            @error('name')
                        ...
                        <a href="{{ route('admin.user.index')}}"><input type="submit" class="btn btn-primary" value="Добавить"></a>
                    </form>
                </div>
            </div>
            <!-- /.row -->
